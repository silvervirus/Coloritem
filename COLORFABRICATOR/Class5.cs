...
namespace COLORFABRICATOR
{
    public static class Config
    {
        ...
        public static void Load()
        {
            ...
            fabricatorColor = PlayerPrefsExtra.GetBool("itemColor", true);
        }
    }

    public class Options : ModOptions
    {
        public Options() : base("Color item Settings")
        {
        ...
        public override void BuildModOptions()
        {
            ...
            if ( Config.fabricatorColor == true)
            {
                ...
                AddSliderOption("fabricatorr", "item Red", 0, 255, Config.fabricatorValue);
                AddSliderOption("fabricatorg", "item Green", 0, 255, Config.fabricatorgValue);
                AddSliderOption("fabricatorb", "item Blue", 0, 255, Config.fabricatorbValue);
